...
const HeroForm = ({ isLogin, link, apiLink, navigateLink }) => {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center bg-[url('https://ik.imagekit.io/qsm4jtc2a/Hero_and_logo_images/netflix-hero-image.jpg')] bg-no-repeat bg-cover">
